...
author: Justin McCarthy (co-founder, CTO, StrongDM)
date: 2026-02-06
---
...
<!-- image: Compounding correctness vs compounding error -->
...
<!-- image: Synthetic scenario curation and shaping interface -->
...
> "The Digital Twin Universe is our answer: behavioral clones of the third-party services our software depends on."
...
<!-- images: Okta twin, Jira twin, Google Docs twin, Slack twin, Google Drive twin, Google Sheets twin -->
...
1. We are not alone in these convictions. See also: Luke PM's "The Software Factory", Sam Schillace's "I Have Seen the Compounding Teams", and Dan Shapiro's "Five Levels from Spicy Autocomplete to the Software Factory".

2. Others are building factories too: Devin, 8090, Factory, Superconductor, and Jesse Vincent's Superpowers.
