...
class TestSettingsDefaults:
    ...
    def test_defaults(self, monkeypatch):
        ...
        # session_secret_key is required (no default) — must be provided explicitly
        settings = Settings(_env_file=None, session_secret_key="test-secret")
...
class TestCommaSeparatedParsing:
    ...
    def test_comma_separated_parsing(self):
        settings = Settings(authorized_issuers="a,b,c", session_secret_key="test")
        assert settings.authorized_issuers == {"a", "b", "c"}

    def test_comma_separated_with_whitespace(self):
        settings = Settings(authorized_domains=" a , b ", session_secret_key="test")
        assert settings.authorized_domains == {"a", "b"}

    def test_comma_separated_empty_string(self):
        settings = Settings(authorized_issuers="", session_secret_key="test")
        assert settings.authorized_issuers == set()
    ...
    def test_comma_separated_single_value(self):
        settings = Settings(authorized_audience="https://accounts.google.com", session_secret_key="test")
    ...
    def test_comma_separated_from_env(self, monkeypatch):
        ...
        settings = Settings(session_secret_key="test")
        assert settings.authorized_issuers == {"x", "y", "z"}

    def test_comma_separated_accepts_set(self):
        settings = Settings(authorized_issuers={"already", "a", "set"}, session_secret_key="test")
...
class TestAdminSettings:
    ...
    def test_admin_sa_key_file_default(self):
        settings = Settings(admin_sa_key_file=None, _env_file=None, session_secret_key="test")
        assert settings.admin_sa_key_file is None

    def test_admin_sa_key_file_set(self):
        settings = Settings(admin_sa_key_file="secrets/admin.json", _env_file=None, session_secret_key="test")
        assert settings.admin_sa_key_file == "secrets/admin.json"

    def test_admin_emails_comma_separated(self):
        settings = Settings(dockmaster_admin_emails="a@co.com,b@co.com", _env_file=None, session_secret_key="test")
    ...
    def test_admin_emails_empty_default(self, monkeypatch):
        ...
        settings = Settings(_env_file=None, session_secret_key="test")
        assert settings.dockmaster_admin_emails == set()

    def test_admin_emails_single(self):
        settings = Settings(dockmaster_admin_emails="admin@co.com", _env_file=None, session_secret_key="test")
...
class TestLogLevel:
    ...
    def test_log_level_normalized_to_uppercase(self):
        settings = Settings(log_level="debug", session_secret_key="test")
        assert settings.log_level == "DEBUG"

    def test_log_level_already_uppercase(self):
        settings = Settings(log_level="WARNING", session_secret_key="test")
...
class TestClientSecret:
    ...
    def test_client_secret_is_secret_str(self):
        settings = Settings(client_secret="mysecret", session_secret_key="test")
...
class TestPhase7Settings:
    ...
    def test_dockmaster_token_ttl_custom(self):
        settings = Settings(dockmaster_token_ttl=3600, _env_file=None, session_secret_key="test")
    ...
    def test_allowed_redirect_uris_default_empty(self):
        settings = Settings(allowed_redirect_uris="", _env_file=None, session_secret_key="test")
    ...
    def test_allowed_origins_default_empty(self):
        settings = Settings(allowed_origins="", _env_file=None, session_secret_key="test")
        assert settings.allowed_origins == set()

    def test_allowed_origins_comma_separated(self):
        settings = Settings(
            allowed_origins="https://app.example.com,https://other.com", _env_file=None, session_secret_key="test"
        )
    ...
    def test_jwks_registry_path_custom(self):
        settings = Settings(jwks_registry_path="/tmp/jwks.json", _env_file=None, session_secret_key="test")
...
class TestCreateSettings:
    ...
    def test_create_settings_returns_settings(self, monkeypatch):
        monkeypatch.setenv("SESSION_SECRET_KEY", "test")
        result = create_settings()
        assert isinstance(result, Settings)

    def test_create_settings_returns_fresh_instance(self, monkeypatch):
        monkeypatch.setenv("SESSION_SECRET_KEY", "test")
